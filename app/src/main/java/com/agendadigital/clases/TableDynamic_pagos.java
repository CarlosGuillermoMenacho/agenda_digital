...
public class TableDynamic_pagos {
    ...
    public TableDynamic_pagos(TableLayout tableLayout, Context context) {
    ...
    public void cargarNotas(TableLayout tableLayout,Context context){
        ...
        final TableDynamic_pagos tableDynamic = new TableDynamic_pagos(tableLayout,context);
